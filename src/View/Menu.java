...
public class Menu {
    ...
    public void showMenu(VehicleFactory vehicleFactory, EntityManager entityManager) {
        ...
        do {
            ...
            switch (option) {
                case 1:
                    handleCreateVehicle(vehicleFactory, entityManager);
                    break;
                case 2:
                    handleAddEmployee(entityManager);
                    break;
                case 3:
                    handleAssignEmployeeToVehicle(entityManager);
                    break;
                case 4:
    ...
    private void handleCreateVehicle(VehicleFactory vehicleFactory, EntityManager entityManager) {
    ...
    private void handleAddEmployee(EntityManager entityManager) {
        System.out.print("ID: ");
